        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Color = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "#1976d2"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    StatValue = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    StatColor = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "primary"),
                    IconName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecentActivities_ActivityTypes_ActivityTypeId",
                        column: x => x.ActivityTypeId,
                        principalTable: "ActivityTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecentActivities_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecentActivities_ActivityTypeId",
                table: "RecentActivities",
                column: "ActivityTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_RecentActivities_CreatedAt",
                table: "RecentActivities",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_RecentActivities_EmployeeId",
                table: "RecentActivities",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_RecentActivities_UserId_CreatedAt",
                table: "RecentActivities",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleMenuPermissions_Role_MenuItemId",
                table: "RoleMenuPermissions",
                columns: new[] { "Role", "MenuItemId" },
                unique: true);
