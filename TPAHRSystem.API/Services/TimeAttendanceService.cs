// =============================================================================
// SIMPLE MOCK TIME ATTENDANCE SERVICE
// File: TPAHRSystem.API/Services/TimeAttendanceService.cs (Replace existing)
// =============================================================================
...
namespace TPAHRSystem.API.Services
{
    public class TimeAttendanceService : ITimeAttendanceService
    {
        ...
        public TimeAttendanceService(ILogger<TimeAttendanceService> logger)
        {
            _logger = logger;
        }
        ...
        {
            _logger.LogInformation($"Clocking in employee {employeeId} at {location}");
        ...
        {
            _logger.LogInformation($"Clocking out employee {employeeId}");
        ...
        {
            _logger.LogInformation($"Getting stats for employee {employeeId}");
        ...
        {
            _logger.LogInformation($"Getting time entries for employee {employeeId}");
        ...
        {
            _logger.LogInformation($"Getting current week timesheet for employee {employeeId}");
        ...
        {
            _logger.LogInformation($"Getting timesheets for employee {employeeId}");
        ...
        {
            _logger.LogInformation($"Submitting timesheet {timesheetId} for employee {employeeId}");
            await Task.Delay(100);
            return true;
        }
        ...
        {
            _logger.LogInformation($"Getting pending timesheets for role {role}");
            await Task.Delay(100);
            return new List<TimeSheetDto>();
        }
        ...
        {
            _logger.LogInformation($"Approving timesheet {timesheetId} by {approverId}");
            await Task.Delay(100);
            return true;
        }
        ...
        {
            _logger.LogInformation($"Rejecting timesheet {timesheetId} by {approverId}");
            await Task.Delay(100);
            return true;
        }
        ...
        {
            _logger.LogInformation($"Getting attendance summary for role {role}");
        ...
        {
            _logger.LogInformation($"Getting schedule for employee {employeeId}");
            await Task.Delay(100);
